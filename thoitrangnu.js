...
var proCard = [];
var proWoman = {
    img: ["https://preview.redd.it/0ooxxun2fr081.jpg?width=640&crop=smart&auto=webp&s=e6379193a53f34a380da394bd153b774448444be", "https://media.vogue.co.uk/photos/60435df8107e7ce55db43fb9/master/w_1080,h_1350,c_limit/jisoo%204.jpeg",
        "https://cdn.lifestyleasia.com/wp-content/uploads/sites/2/2021/03/11094125/dior-hisbiscus-medium-lady-d-lite-handbag-jisoo.jpg", "https://cdnmedia.thethaovanhoa.vn/Upload/BLtvcXjb72tSqs1jiHr8g/files/2021/08/V-alone1.jpg",
...
function add(i) {
    ...
    proCard.push({
        ...
        amount: 1,
        totalItemPrice: proWoman.pricePro[i] * 1,
    });
    ...
    for (var x = proCard.length - 1; x >= 0; x--) {
        ...
        <td> <input type="number" min="0" max="10" value="0" id="qty${x}"  oninput="total(${x}); changeAmount(${x})"></td>
        <td id="total${x}"> </td>
        </tr>        
        `;

        document.getElementById('card').innerHTML += card;
        var qtty = document.getElementById('qty' + x).value;
        document.getElementById('total' + x).innerHTML = "$" + qtty * proCard[x].pricePro;
        break;
    }
}
    ...
    for (let i = 0; i < proCard.length; i++) {
        var element =
            ...
            <div class="item-describe">
                <img src="${proCard[i].img}" alt="" style="width:100px; height:130px; object-fit:cover;">
                <div class="detailed">
...
function showLastInfo() {
    ...
    document.getElementById('total-value').innerHTML = tongCong;
}